...
for index, l_aeroportos in aeroportos1.iterrows():
    arquivo.write(str(l_aeroportos['ID_REGIAO']))
    arquivo.write('\t')
    arquivo.write(str(l_aeroportos['ID_AEROPORTO']))
    arquivo.write('\t')
    arquivo.write(str(l_aeroportos['LATITUDE']))
    arquivo.write('\t')
    arquivo.write(str(l_aeroportos['LONGITUDE']))
    arquivo.write('\n')
